...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
                  stop_steering_temp, lkas11, sys_warning, sys_state, enabled,
  ...
  values["CF_Lkas_ActToi"] = steer_req and not stop_steering_temp
  values["CF_Lkas_ToiFlt"] = stop_steering_temp
